    ...
    const customers = [
      {
        ...
        country: 'USA',
        currency: '$',
        email: 'carson.darrin@prueba.com',
      ...
      },
      {
        ...
        avatar: '/mock-images/avatars/avatar-fran_perez.png',
        city: 'Atlanta',
        country: 'USA',
        currency: '$',
        email: 'fran.perez@prueba.com',
        hasAcceptedMarketing: true,
        isProspect: true,
        isReturning: false,
        name: 'Fran Perez',
      ...
      },
      {
        ...
        country: 'USA',
        currency: '$',
        email: 'penjani.inyene@prueba.com',
        hasAcceptedMarketing: false,
        isProspect: true,
        isReturning: false,
        name: 'Penjani Inyene',
      ...
      },
      {
        ...
        avatar: '/mock-images/avatars/avatar-omar_darboe.png',
        currency: '$',
        email: 'omar.darobe@prueba.com',
        hasAcceptedMarketing: true,
        isProspect: false,
        isReturning: false,
        city: 'Carson City',
      ...
      },
      {
        ...
        country: 'USA',
        currency: '$',
        email: 'siegbert.gottfried@prueba.com',
        hasAcceptedMarketing: true,
        isProspect: false,
        isReturning: true,
      ...
      },
      {
        ...
        avatar: '/mock-images/avatars/avatar-iulia_albu.png',
        city: 'Murray',
        country: 'USA',
        email: 'iulia.albu@prueba.com',
        hasAcceptedMarketing: true,
        isProspect: true,
        isReturning: false,
        name: 'Iulia Albu',
      ...
      },
      {
        ...
        country: 'USA',
        currency: '$',
        email: 'nasimiyu.danai@prueba.com',
        hasAcceptedMarketing: false,
        isProspect: false,
        isReturning: true,
        name: 'Nasimiyu Danai',
...
getCustomerLogs() {
    const logs = [
      ...
      },
      {
        ...
        description: 'Removio del carrito',
        ip: '84.234.243.42',
        method: 'DELETE',
